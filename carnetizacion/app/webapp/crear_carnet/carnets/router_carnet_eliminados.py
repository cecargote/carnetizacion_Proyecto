...
async def carnet_eliminado(request: Request, db: Session = Depends(get_db)):
    ...
    try:
        ...
        response = templates.TemplateResponse(
            "general_pages/carnets/carnets_eliminados.html", {"request": request, "carnets": carnets, "persons": persons, "motivos":motivos, "page_obj": page_obj}
        )
        try:
